...
uses
  ...
  System.Threading, System.Net.HttpClient, System.JSON, System.Hash, System.NetEncoding, ComObj, Variants; // ★ここに魔改造に必要な最新コアライブラリ群を完全融合！
...
const
  STR_INFO = 'ネットワーク処理プラグイン by クジラ飛行机（ウルトラモッド拡張版）';
begin
